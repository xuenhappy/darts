...
// repeated string Labels = 9;
inline int DRegexDat::_internal_labels_size() const {
  return labels_.size();
}
inline int DRegexDat::labels_size() const {
  return _internal_labels_size();
}
inline void DRegexDat::clear_labels() {
  labels_.Clear();
}
inline std::string* DRegexDat::add_labels() {
  std::string* _s = _internal_add_labels();
  // @@protoc_insertion_point(field_add_mutable:darts.DRegexDat.Labels)
  return _s;
}
inline const std::string& DRegexDat::_internal_labels(int index) const {
  return labels_.Get(index);
}
inline const std::string& DRegexDat::labels(int index) const {
  // @@protoc_insertion_point(field_get:darts.DRegexDat.Labels)
  return _internal_labels(index);
}
inline std::string* DRegexDat::mutable_labels(int index) {
  // @@protoc_insertion_point(field_mutable:darts.DRegexDat.Labels)
  return labels_.Mutable(index);
}
inline void DRegexDat::set_labels(int index, const std::string& value) {
  labels_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:darts.DRegexDat.Labels)
}
inline void DRegexDat::set_labels(int index, std::string&& value) {
  labels_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:darts.DRegexDat.Labels)
}
inline void DRegexDat::set_labels(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  labels_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:darts.DRegexDat.Labels)
}
inline void DRegexDat::set_labels(int index, const char* value, size_t size) {
  labels_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:darts.DRegexDat.Labels)
}
inline std::string* DRegexDat::_internal_add_labels() {
  return labels_.Add();
}
inline void DRegexDat::add_labels(const std::string& value) {
  labels_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:darts.DRegexDat.Labels)
}
inline void DRegexDat::add_labels(std::string&& value) {
  labels_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:darts.DRegexDat.Labels)
}
inline void DRegexDat::add_labels(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  labels_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:darts.DRegexDat.Labels)
}
inline void DRegexDat::add_labels(const char* value, size_t size) {
  labels_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:darts.DRegexDat.Labels)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
DRegexDat::labels() const {
  // @@protoc_insertion_point(field_list:darts.DRegexDat.Labels)
  return labels_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
DRegexDat::mutable_labels() {
  // @@protoc_insertion_point(field_mutable_list:darts.DRegexDat.Labels)
  return &labels_;
}
